...
from utility import myprint as mprint
...
def F_europa_(payload, method):
    ...
    return {"F1": percentage(f1), "F2": percentage(f2), "F3": percentage(f3), "F4": percentage(f4), "GUIDELINES": percentage(dqgf)}
...
def R_europa_(payload):
    ...
    return {"R1": percentage(r1), "R1.1" : percentage(r1_1), "R1.2" : percentage(r1_2), "R1.3" : percentage(r1_3), "GUIDELINES": percentage(dqgr)}
